...
import WalkSafeHome from "../public/assets/images/WalkSafeHome.jpg";
...
const kaushenScript = Kaushan_Script({
  subsets: ["latin"],
  display: "swap",
  weight: "400",
});
  ...
  return (
    ...
    >
      ...
      <div className="navbar  top-0">
        ...
        >
          <a
            className="btn btn-ghost font-bold mainNavText"
            style={{
              fontSize: "2rem",
              fontWeight: "bold",
              ...
              >
                ...
                >
                  ...
                  <p className="card-para">
                    Anonimo is a social media website allowing users to make
                    posts expressing their emotioms. The website also have
                    support for a therapist section where users can make
                    appointments with therapists and have a chat with them.
                  </p>
              ...
              >
                ...
                >
                  ...
                  <p className="card-para">
                    ...
                    suspicious(missing) person and detect whether the captured
                    image is of a missing person or not and notify the nearest
                    and root police stations.
                  </p>
                  <div className="card-actions justify-end">
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <p className="card-para">
                    Introducing WalkSafe, your ultimate companion for ensuring
                    the safety of your loved ones while navigating through the
                    city. WalkSafe is a comprehensive mobile application
                    available on both Android and iOS platforms, designed to
                    provide real-time tracking, route optimization, and safety
                    alerts to keep you and your family secure at all times.
                  </p>
                  <div className="card-actions justify-end">
                    <a href="https://github.com/rangelkoli/FindX">
                      <button style={{ display: "flex", alignItems: "center" }}>
            ...
            <div className="flex flex-wrap items-center ">
              <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0">
                <div className="lg:max-w-md">
                  ...
                  <h2
                    className="mt-4 mb-6 text-2xl  dark:text-gray-300"
                    style={{
                      textAlign: "justify",
                    }}
                  >
                    Greetings! I am Rangel Anselm Koli, a passionate and
                    dedicated software developer based in Syracuse, NY. Pursuing
                    a Master&apos;s in Computer Science from Syracuse University
                    and a strong foundation in Information Technology from
                    Mumbai University, I am committed to contributing my
                    technical acumen to drive innovation and facilitate
                    organizational growth in the dynamic field of IT.
                  </h2>
                </div>
              </div>
              <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0">
                ...
                <div className="flex mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-base leading-loose text-gray-500 dark:text-gray-400">
                      1st Place in the Code Crush 1.0 Hackathon organized by St.
                      Francis Institute of Technology
                    </p>
                    <p className="text-base leading-loose text-gray-500 dark:text-gray-400">
                      Coursera - Programming Foundations with JavaScript, HTML
                      and CSS (2020)
                    </p>
                  </div>
                </div>
